            ...
            function matchBreadCrumbs() {
                ...
                if (bcTrailAll.length === 1) {
                    ...
                    bcTrailAll.each(function(i) {
                        ...
                        if (currentCookieVal.length === linkEls.length) {
                            ...
                            //console.log("currentCookieVal.length", currentCookieVal.length);
                            //console.log("linkEls.length", linkEls.length);
                            if (match) {
